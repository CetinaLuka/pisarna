<?php
/*
Plugin Name: The Events Calendar Event Details Page Templates
Plugin URI: https://eventscalendartemplates.com/
Description: Design awesome single event page for The Events Calendar free plugin (by modern tribe) using Event Page Templates Addon.
Version: 1.4.2
Author:  Cool Plugins
...
if (!defined('EPTA_PLUGIN_CURRENT_VERSION')) {
    define('EPTA_PLUGIN_CURRENT_VERSION', '1.4.2');
}
